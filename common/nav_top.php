                ...
                <div class="col-lg-offset-1 col-lg-10">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <?php if (isset($_COOKIE['memberID'])) { ?>
                            <li><a href="" target="_blank"><span class="glyphicon glyphicon-user"></span><?php echo $last_name.$first_name?></a>
                            </li>
                            <li><a href="notice.php" target="_blank"><span class="glyphicon glyphicon-bell"></span></a>
                            </li>
                            <li><a href="Upload_Video" target="_blank"><span
                                            class="glyphicon glyphicon-open"></span></a>
                            </li>
                            <li><a href="#" onclick="logoutRequest();"><span class="glyphicon glyphicon-log-in"></span></a>
                            </li>
                        <?php } else { ?>
                            <li><a href="#" onclick="openNav();"><span class="glyphicon glyphicon-log-in"></span></a>
                            </li>
                        <?php } ?>
                    </ul>
                    <!--首頁-->
